  ...
  return (
    <div ref={cont} className='w-screen fixed shadow-sm shadow-white z-20 bg-gray-800'>
        <div className='flex justify-between items-center py-2 px-4 lg:px-4 ' >
            <div >
                <img src={"/Logo.png"} alt="" className='w-[40px] bg-white bg-transparent' />
            </div>
            ...
            <div className='hidden lg:flex lg:flex-row text-white justify-between space-x-[350px] ' >
                <ul className=' flex gap-4 text-[18px] font-bold '>
                   <Link href='#hero'> <li className='hover:text-[#3A0879] cursor-pointer focus:bg- from-gray-800 to-fuchsia-800'>Home</li></Link>
            ...
            <div ref={menuRef} onClick={menuOpen} className='flex lg:hidden visible'>
                <FaAlignJustify size={30} className='text-white'/>
            </div>
        ...
        <div ref={listRef} className='hidden'>
                ...
                <Link  href='#hero'> <li className='hover:text-[#3A0879] cursor-pointer hover:border-b-2'>Home</li></Link>
                <Link href='#project'><li className='hover:text-[#3A0879] cursor-pointer'>Projects</li></Link>
                    <Link href='#skill'> <li className='hover:text-[#3A0879] cursor-pointer'>Skills</li></Link>
                    <Link href='#contact'> <li className='hover:text-[#3A0879] cursor-pointer'>Contact</li></Link>
                </ul>
